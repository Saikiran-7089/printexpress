...
// Customer Endpoints
router.post('/upload', verifyToken, requireCustomer, upload.array('files', 10), uploadDocuments);
router.post('/checkout', verifyToken, requireCustomer, checkout);
router.post('/:orderId/pay', verifyToken, requireCustomer, upload.single('screenshot'), processPayment);
